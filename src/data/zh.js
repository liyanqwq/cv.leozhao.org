export const zhData = {
  ...
  skills: {
    webDev: {
      title: "全棧網頁開發",
      items: [
        { name: "PHP", value: 90, group: "後端" },
        { name: "Laravel", value: 85, group: "框架" },
        { name: "TALL Stack", value: 80, group: "框架" },
        { name: "Python", value: 85, group: "後端" },
        { name: "Flask", value: 75, group: "框架" },
        { name: "NodeJS", value: 80, group: "後端" },
        { name: "TypeScript", value: 85, group: "語言" },
        { name: "Astro", value: 70, group: "框架" },
        { name: "HTML5", value: 95, group: "前端" },
        { name: "CSS", value: 92, group: "前端" },
        { name: "JavaScript", value: 90, group: "前端" },
        { name: "jQuery", value: 80, group: "庫" },
        ...
        { name: "MySQL", value: 80, group: "數據庫" },
        { name: "MongoDB", value: 75, group: "數據庫" },
      ],
    },
    programming: {
      title: "編程與數據分析",
