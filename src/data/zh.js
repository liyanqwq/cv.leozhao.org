export const zhData = {
  ...
  summary:
    "香港理工大學資訊安全專業在讀，有幸參與多項網絡安全競賽並取得不錯成績，包括幾次CTF競賽冠軍。在全棧網頁開發領域不斷學習成長，積累了使用現代技術開發和維護網絡應用的實踐經驗。正努力提升滲透測試、數碼鑑證和算法競賽方面的能力，希望未來能有更多貢獻。能以普通話、英語和粵語流暢溝通，樂於與不同背景的夥伴合作交流。",
  skills: {
    webDev: {
      title: "全棧網頁開發",
      items: [
        { name: "PHP", value: 90, group: "Backend", groupTitle: "後端" },
        { name: "Laravel", value: 85, group: "Framework", groupTitle: "框架" },
        { name: "TALL Stack", value: 80, group: "Framework", groupTitle: "框架" },
        { name: "Python", value: 85, group: "Backend", groupTitle: "後端" },
        { name: "Flask", value: 75, group: "Framework", groupTitle: "框架" },
        { name: "NodeJS", value: 80, group: "Backend", groupTitle: "後端" },
        { name: "TypeScript", value: 85, group: "Language", groupTitle: "語言" },
        { name: "Astro", value: 70, group: "Framework", groupTitle: "框架" },
        { name: "HTML5", value: 95, group: "Frontend", groupTitle: "前端" },
        { name: "CSS", value: 92, group: "Frontend", groupTitle: "前端" },
        { name: "JavaScript", value: 90, group: "Frontend", groupTitle: "前端" },
        { name: "jQuery", value: 80, group: "Library", groupTitle: "庫" },
        ...
        { name: "MySQL", value: 80, group: "Database", groupTitle: "數據庫" },
        { name: "MongoDB", value: 75, group: "Database", groupTitle: "數據庫" },
      ],
    },
    programming: {
      title: "編程與數據分析",
