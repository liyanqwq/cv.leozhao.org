export const enData = {
  ...
  skills: {
    webDev: {
      ...
      items: [
        { name: "PHP", value: 90, group: "Backend" },
        { name: "Laravel", value: 85, group: "Framework" },
        { name: "TALL Stack", value: 80, group: "Framework" },
        { name: "Python", value: 85, group: "Backend" },
        { name: "Flask", value: 75, group: "Framework" },
        { name: "NodeJS", value: 80, group: "Backend" },
        { name: "TypeScript", value: 85, group: "Language" },
        { name: "Astro", value: 70, group: "Framework" },
        { name: "HTML5", value: 95, group: "Frontend" },
        { name: "CSS", value: 92, group: "Frontend" },
        { name: "JavaScript", value: 90, group: "Frontend" },
        { name: "jQuery", value: 80, group: "Library" },
        { name: "Tailwind CSS", value: 90, group: "CSS" },
        { name: "RESTful API", value: 85, group: "API" },
        { name: "Git", value: 90, group: "DevOps" },
        { name: "Docker", value: 75, group: "DevOps" },
        { name: "MySQL", value: 80, group: "Database" },
        { name: "MongoDB", value: 75, group: "Database" },
      ],
    },
    programming: {
